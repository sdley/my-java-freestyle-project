...
2. Navigate to the Java file you want to run
3. Click the "Run" button or use the keyboard shortcut (usually Shift+F10 in IntelliJ, Ctrl+F11 in Eclipse)
...
### Online Courses
- [Java Programming on Coursera](https://www.coursera.org/courses?query=java)
- [Java Tutorial on W3Schools](https://www.w3schools.com/java/)
...
- **Issues**: Found a bug or have a suggestion? [Open an issue](https://github.com/sdley/my-java-freestyle-project/issues)
- **Discussions**: Have questions? Start a [discussion](https://github.com/sdley/my-java-freestyle-project/discussions)
...
[⬆ Back to Top](#-my-java-freestyle-project)
